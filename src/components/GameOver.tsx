  ...
  return (
      <AlertDialog open={props.open} onOpenChange={props.onOpenChange}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            {!props.win && (
              <AlertDialogTitle className="text-center font-pageName text-[100px]">
                Game Over
              </AlertDialogTitle>
            )}
            {props.win && (
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={props.playAgain}>
              Play Again
            </AlertDialogCancel>
            <AlertDialogAction onClick={() => navigate('/play/leaderboard')}>
              View Leaderboard
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
